...
import { Camera, Image as ImageIcon, X, Send, BookOpen } from 'lucide-react'
...
const MODES = [
  { id: 'answer_only', label: 'Faqat javob', cmd: '/qisqa' },
  { id: 'short', label: 'Qisqa izoh', cmd: '' },
  { id: 'full', label: 'Bosqichma-bosqich', cmd: '/toliq' },
  { id: 'notebook', label: 'Daftar formati', cmd: '/daftar' },
  { id: 'quiz', label: 'Test yaratish', cmd: '/test 5' },
  { id: 'translate', label: 'Tarjima', cmd: '/tarjima auto uz' },
] as const
...
export default function Personal() {
  ...
  return (
    <div className="hide-sb" style={{ flex: 1, overflowY: 'auto', padding: 'var(--s-5)' }}>
      <div style={{ maxWidth: 680, margin: '0 auto', display: 'grid', gap: 'var(--s-4)' }}>
