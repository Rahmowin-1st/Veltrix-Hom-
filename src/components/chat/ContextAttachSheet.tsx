          ...
          <motion.section className="v5-context-sheet" role="dialog" aria-modal="true" aria-label="Chat konteksti"
            ...
            <div className="row" style={{ padding: '14px 16px 4px' }}>
              <div>
                ...
                <p className="micro">Fayl, manba va Talent bir vaqtda ishlashi mumkin.</p>
              </div>
            ...
            <div className="v5-context-tabs">
              ...
              <TabButton active={tab === 'skill'} onClick={() => setTab('skill')} icon={<Sparkles size={17}/>} label="Talent" />
            </div>
            ...
            {(tab === 'source' || tab === 'skill') && (
              <label className="surface-2 row" style={{ margin: '0 14px 7px', height: 44, padding: '0 12px', borderRadius: 17 }}>
                ...
                <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder={tab === 'source' ? 'Manba qidirish…' : 'Talent qidirish…'}
              ...
              {tab === 'skill' && (
                <div style={{ display: 'grid', gap: 4 }}>
                  <button className="v5-picker-item" onClick={p.onCreateSkill}>
                    ...
                    <span className="col" style={{ gap: 2 }}><strong>Yangi Talent yaratish</strong><span className="micro">Claude Talent kabi qayta ishlatiladigan yo‘riqnoma</span></span>
                  </button>
                  <button className="v5-picker-item" data-selected={!p.activeSkillId} onClick={() => p.onSelectSkill(null)}>
                    ...
                    <span className="col" style={{ flex: 1 }}><strong>Talentsiz</strong><span className="micro">Oddiy Veltrix yordamchi</span></span>
