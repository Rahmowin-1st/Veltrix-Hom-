  ...
  return (
    <div className="v5-chat-composer-wrap">
      <div style={{ width: 'min(780px,100%)', marginInline: 'auto' }}>
        ...
        <div className="v5-chat-composer" data-focused={focused} data-sending={sendFlash}>
          ...
          <div className="v5-composer-row">
            <button className="v5-round-icon" style={{ width: 48, height: 48, flex: '0 0 48px' }} onClick={() => setSheetOpen(true)} aria-label="Fayl, manba yoki skill qo‘shish"><Plus size={22}/></button>
      ...
      <ContextAttachSheet open={sheetOpen} onClose={() => setSheetOpen(false)} sources={p.allSources} skills={skills}
        ...
        onCreateSkill={() => { setSheetOpen(false); navigate('/skills?add=1') }} onError={setError}/>
    </div>
  )
}
