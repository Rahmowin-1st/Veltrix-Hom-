...
class CurrencyRefreshWorker(context: Context, params: WorkerParameters): Worker(context,params) {
    override fun doWork(): Result {
        ...
        val widgetPairs=WidgetProductRuntime.configuredCurrencyPairs(applicationContext)
        ...
        WidgetProductRuntime.refreshCurrencyWidgetsFromCache(applicationContext)
