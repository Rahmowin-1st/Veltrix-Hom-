...
const GROUPS: { id:GroupId; title:string; description:string; icon:React.ReactNode; color:string }[] = [
  ...
  {id:'skills',title:'Skills',description:'Claude uslubidagi AI yo‘riqnomalari',icon:<Sparkles/>,color:'#D5366A'},
