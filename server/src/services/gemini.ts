    ...
    withBackoff(async () => {
      ...
      const res = await ai.models.generateContent({
        ...
        config: {
          ...
          // Gemini 3.x rejects legacy sampling controls such as temperature/topP/topK.
          // Grounding and reproducibility are enforced by system instructions and source context.
        },
      })
