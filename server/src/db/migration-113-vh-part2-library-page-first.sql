-- Veltrix Hom Backend Part 2: page-first Library query.
-- Preserve the public service contract while moving expensive relationship counts
-- after filter/sort/cursor/limit so only the returned page is enriched.
